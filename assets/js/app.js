...
function sumarCantidad(event) {
    ...
    var stock = parseInt(selector.getElementsByClassName('carrito-item-cantidad')[0].getAttribute('data-stock'));
...
function restarCantidad(event) {
    ...
    var selector = buttonClicked.parentElement;
    var cantidadActual = parseInt(selector.getElementsByClassName('carrito-item-cantidad')[0].value);
    var stockMin = parseInt(selector.getElementsByClassName('carrito-item-cantidad')[0].getAttribute('data-stock-min'));
